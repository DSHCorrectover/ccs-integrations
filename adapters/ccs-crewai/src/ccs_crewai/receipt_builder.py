...
context) and produces the exact 30-field CCS L1 receipt plus the linked
``ccs.behavior_evidence.v1`` receipt.
...
# Exact 30-field L1 receipt shape. Used to guarantee the generated dict is
# accepted by strict L1 parsers with no unknown fields and no missing fields.
L1_FIELDS: tuple[str, ...] = (
    "trace_id",
    "receipt_version",
    "verdict",
...
class ReceiptBuilder:
    ...
    def __init__(
        ...
        *,
        ...
        # Deterministic config hash: all static config that affects receipt
